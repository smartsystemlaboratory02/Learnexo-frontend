...
const Question = ({ questionObject }: { questionObject: QuestionProps }) => {
    ...
    return (
        <div className={`flex items-start gap-6`}>
            <div className='bg-gray-3 text-blue-5 w-[30px] h-[30px] rounded-full text-center flex justify-center items-center text-[18px] font-semibold shrink-0'>{index}</div>
            <div>
